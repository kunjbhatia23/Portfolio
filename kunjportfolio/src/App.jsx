 ...
 * @returns {[Function, IntersectionObserverEntry | null]} - A ref setter function and the observer entry.
 */
...
export default function App() {
    ...
    // Effect to handle mouse move for the spotlight
    useEffect(() => {
...
const StyleTag = () => (
    <style>{`
        ...
        .light-theme {
            --bg-color: #F5F5F5;
            --text-color: #333333;
            --primary-color: #7c3aed; /* Slightly darker purple for better contrast */
        ...
        * {
        ...
        .aurora-shape.shape1 {
            width: 500px; height: 500px; background: #5831d1; top: -100px; left: -100px;
            animation: moveAurora1 20s infinite alternate ease-in-out;
        }
        .aurora-shape.shape2 {
            width: 400px; height: 400px; background: #d322c3; bottom: -50px; right: -50px;
            animation: moveAurora2 25s infinite alternate ease-in-out;
        }
        .aurora-shape.shape3 {
            width: 300px; height: 300px; background: #22d3ee; bottom: 100px; left: 200px;
            animation: moveAurora3 18s infinite alternate ease-in-out;
        }
        ...
        @keyframes moveAurora2 {
            from { transform: translate(0, 0) rotate(0deg); }
            to { transform: translate(-300px, -200px) rotate(270deg); }
        }
        @keyframes moveAurora3 {
            from { transform: translate(0, 0) rotate(0deg); }
            to { transform: translate(100px, -200px) rotate(90deg); }
        }
        ...
        h2 { font-size: 3rem; }
        h3 { font-size: 1.8rem; }
        h4 { font-size: 1.4rem; color: var(--primary-color); margin-bottom: 1rem; }
        
        .section-title {
            text-align: center; margin-bottom: 4rem; position: relative; display: flex;
            align-items: center; justify-content: center; gap: 15px; color: var(--heading-color);
        ...
        /* --- Header --- */
        .header {
            position: sticky; top: 0; width: 100%; background-color: var(--header-bg);
            backdrop-filter: blur(16px); z-index: 10; padding: 1.2rem 0; border-bottom: 1px solid var(--border-color);
        }
        .header .container {
            display: flex; justify-content: space-between; align-items: center;
            padding: 0 2rem; width: 100%; max-width: var(--container-width); margin: 0 auto;
        }
        a.logo {
            font-family: var(--font-heading); font-size: 1.8rem; font-weight: 700;
            color: var(--primary-color); text-shadow: 0 0 5px rgba(147, 51, 234, 0.5);
        }
        a.logo:hover { color: var(--primary-color); transform: scale(1.05); }
        
        .header nav { display: flex; gap: 1.5rem; }
        .header nav a {
            font-weight: 500; font-size: 1rem; position: relative; color: var(--text-color);
        }
        .header nav a::after {
            content: ''; position: absolute; left: 0; bottom: -5px; width: 0; height: 2px;
            background-color: var(--heading-color); transition: width 0.3s ease;
        }
        ...
        .hero p {
            font-size: 1.7rem; max-width: 700px; margin: 1.5rem auto 3rem auto;
        ...
        .cta-button {
            display: inline-flex; align-items: center; gap: 10px; padding: 1.2rem 2.5rem;
            background: linear-gradient(45deg, var(--primary-color), #da6ee0); color: #fff;
            border-radius: 8px; font-weight: 700; font-family: var(--font-heading); font-size: 1.1rem;
            text-transform: uppercase; letter-spacing: 0.05em; transition: all 0.3s ease;
            border: none; box-shadow: 0 5px 15px rgba(147, 51, 234, 0.4);
        }
        ...
        .skill-tag {
            background-color: rgba(42, 42, 42, 0.7); padding: 10px 20px;
            border: 1px solid var(--primary-color); border-radius: 25px; font-size: 0.95rem;
            font-weight: 500; transition: all 0.3s ease; opacity: 0; animation: fadeInUp 0.5s ease forwards;
        }
        ...
        .timeline-item {
            position: relative; margin-bottom: 3rem; padding-left: 60px; opacity: 0;
            transform: translateX(-50px); transition: opacity 0.6s ease-out, transform 0.6s ease-out;
        }
        .timeline-item.is-visible { opacity: 1; transform: translateX(0); }
        .timeline-item::before {
            content: ''; position: absolute; left: 8px; top: 5px; width: 25px; height: 25px;
            background-color: var(--primary-color); border-radius: 50%; border: 4px solid var(--bg-color);
        }
        ...
        .service-card, .project-card, .education-card, .achievement-column {
            background-color: var(--card-bg-color); border: 1px solid var(--border-color);
            backdrop-filter: blur(10px); border-radius: 12px; padding: 2.5rem;
            transition: transform 0.3s ease, box-shadow 0.3s ease, border-color 0.3s ease;
        }
        .service-card:hover, .project-card:hover {
            transform: translateY(-10px); box-shadow: 0 15px 30px rgba(0,0,0,0.1); border-color: var(--primary-color);
        }
        ...
        .project-tags .tag {
            background-color: rgba(147, 51, 234, 0.2); color: var(--primary-color);
        ...
        .project-links a {
            ...
            background-color: var(--primary-color); padding: 0.7rem 1.2rem; border-radius: 5px;
        }
        ...
        .terminal-window {
            max-width: 800px; margin: 2rem auto; background: var(--terminal-bg);
            border: 1px solid var(--border-color); border-radius: 8px; box-shadow: 0 10px 30px rgba(0,0,0,0.2);
        }
        ...
        /* --- Footer --- */
        .footer {
            text-align: center; padding: 3rem 0; border-top: 1px solid var(--border-color);
        ...
        @media (max-width: 768px) {
            ...
            .header nav a { font-size: 2rem; margin: 1rem 0; }
